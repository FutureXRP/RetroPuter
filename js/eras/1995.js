  ...
  switch (url) {
    case SITES.home:
      ...
      return { title: 'PrairieNet Online: Welcome to the Web!', cls: 'w95', blocks: [
        ...
        `<h2>Member Pages</h2><ul><li>${A(SITES.kevin, "Kevin's Kool Kyber Korner")} (Kevin's back, and he learned tables!)</li><li>${A('http://www.cyberburbs.com/hollywood/2112/', "Dana's X-Files Fan Page")}</li></ul><p>Get your own <b>free home page</b> on CyberBurbs. 2 MB of space! That's more than a whole floppy disk.</p>`,
        `<h2>This Week</h2><ul><li>${A(SITES.news, 'The Daily Byte')}: Horizon 95 is here, and people waited in line at midnight</li><li>New 28,800 bps access numbers in 40 cities</li><li>${A(SITES.shack, 'Shareware Shack')}: now with pictures in JPEG!</li></ul>`,
